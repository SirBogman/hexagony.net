...
function updateButtons() {
    ...
    updateEditControlsHelper(editControls, {
        canDeleteBreakpoints: userData.breakpoints.length !== 0,
        canEdit: !running,
        canRedo: gridView.canRedo(running),
        canUndo: gridView.canUndo(running),
        onBigger,
        onDeleteBreakpoints,
        onRedo: () => gridView.redo(),
        onReset,
        onSmaller,
