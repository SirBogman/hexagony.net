    ...
    <>
        <main className="about">
            ...
            <p>
                ...
                modifying the program code. Stepping back will never change the program code. If the code has been
                modified since it has executed, stepping back will revert the effects of the instruction that was
                executed, not the instruction as it currently appears. However, stepping forward will execute the
                instruction that currently appears.
            </p>
