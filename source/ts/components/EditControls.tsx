    ...
    return (
        <div id="editControls" className="group">
            ...
            <button
                ...
                <svg className="buttonSvg" viewBox="0 0 42 50">
                    <path fill="none" stroke="currentColor" strokeWidth="3px"
                        d={'M7 49.25L35 .75M8.9 39.95L2 35.97V14.03L21 3.06l6.9 3.98M33.1 10.05l6.9 3.98v21.94L21 46.' +
                           '94l-6.9-3.98'}/>
                </svg>
            </button>
            <button
                ...
                <svg className="buttonSvg" viewBox="0 0 42 50">
                    <path fill="currentColor"
                        d={'M16.29,44.05H14.78q-4,0-5.89-1.85T7,36.57V29.51a6.5,6.5,0,0,0-.22-1.79A3,3,0,0,0,6,26.38a' +
                           '3.86,3.86,0,0,0-1.5-.83,8.17,8.17,0,0,0-2.35-.28H1.22V22.42H2.1a10.11,10.11,0,0,0,2.44-.2' +
                           '5A3.28,3.28,0,0,0,6,21.42a2.68,2.68,0,0,0,.74-1.28A7.64,7.64,0,0,0,7,18.29V13.43a11,11,0,' +
                           '0,1,.41-3.1A5.65,5.65,0,0,1,8.72,8a6,6,0,0,1,2.42-1.5A11,11,0,0,1,14.78,6h1.51V8.82H15.08' +
                           'q-4.76,0-4.75,4.61v4.78c0,3.34-1.45,5.22-4.33,5.64q4.37.43,4.37,5.62v7q0,4.69,4.71,4.69h1' +
                           '.21Z'}/>
                    <path fill="currentColor"
                        d={'M25.69,6H27.2q4,0,5.89,1.85C34.37,9,35,10.92,35,13.43v4.74a6.62,6.62,0,0,0,.22,1.8A3,3,0,' +
                           '0,0,36,21.3a3.71,3.71,0,0,0,1.51.83,8.25,8.25,0,0,0,2.36.29h.88v2.85H39.9a10.26,10.26,0,0' +
                           ',0-2.45.24,3.48,3.48,0,0,0-1.49.75,2.65,2.65,0,0,0-.74,1.28,7.7,7.7,0,0,0-.2,1.85v7.18a11' +
                           ',11,0,0,1-.41,3.1A5.74,5.74,0,0,1,33.27,42a5.94,5.94,0,0,1-2.42,1.5,11.06,11.06,0,0,1-3.6' +
                           '5.52H25.69V41.18h1.23q4.72,0,4.73-4.61v-7.1c0-3.33,1.45-5.21,4.33-5.62q-4.36-.47-4.37-5.6' +
                           '4V13.52q0-4.69-4.69-4.7H25.69Z'}/>
                </svg>
            </button>
            <button
                aria-label="Undo"
                ...
                <svg className="buttonSvg" viewBox="0 0 42 50">
                    <path fill="none" stroke="currentColor" strokeWidth="3px"
                        d={'M13.37 13c4.06-2.69 8.56-4.1 14.19-2.06 7 2.56 9.14 9.36 9.56 11.22a15.33 15.33 0 01-5.27' +
                           ' 14.62c-4.37 3.32-9 4.09-14.51 2.3-5-1.64-8.83-6.52-8.83-9'}/>
            ...
            <button
                ...
                <svg className="buttonSvg" viewBox="0 0 42 50">
                    <path fill="none" stroke="currentColor" strokeWidth="3px"
                        d={'M28.63 13c-4.06-2.68-8.56-4.1-14.19-2-7 2.56-9.14 9.35-9.56 11.21a15.34 15.34 0 005.27 14' +
                           '.63c4.37 3.32 9 4.08 14.51 2.3 5-1.64 8.83-6.52 8.83-9'}/>
